 ...
 * test suite
 */
class classes_filter_number
{
    public static function suite()
    {
        $suite = new cPHP_Base_TestSuite('commonPHP Number Filter Class');
        $suite->addLib();
        $suite->addTestSuite( 'classes_filter_number_tests' );
 ...
 * unit tests
 */
class classes_filter_number_tests extends PHPUnit_Framework_TestCase
{
