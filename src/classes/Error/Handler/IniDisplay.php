...
/**
 * A Handler decorator that will only pass along the error if the display_errors
 * ini setting is set to true
 */
class IniDisplay implements \r8\iface\Error\Handler
{
     ...
     */
    public function __construct ( \r8\iface\Error\Handler $handler )
    {
