...
class Formatter implements \r8\iface\Form\Visitor
{
     ...
     */
    static public function table ( $showErrors, $title = "", $submit = "Submit" )
    {
        return new self(
            $showErrors,
            ...
            new \r8\Template\Callback( array('errors'), function ($errors) {
                ...
                return "<ul class='form-errors'>"
                    ."<li>". implode("</li><li>", (array) $errors) ."</li>"
                    ."</ul>";
            }),
            new \r8\Template\Callback(
                array('form', 'hidden', 'errors', 'fields', 'isFormValid', 'showErrors' ),
                function ($form, $hidden, $errors, $fields, $isFormValid, $showErrors)
                    use ( $title, $submit )
                {
                    $result =
                        "$form\n"
                    ...
                    $submit = \r8\isEmpty((string) $submit)
