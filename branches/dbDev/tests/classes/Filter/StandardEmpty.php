 ...
 * test suite
 */
class classes_filter_standardempty
{
    public static function suite()
    {
        $suite = new cPHP_Base_TestSuite('commonPHP Standard Empty Filter Class');
        $suite->addLib();
        $suite->addTestSuite( 'classes_filter_standardempty_tests' );
 ...
 * unit tests
 */
class classes_filter_standardempty_tests extends PHPUnit_Framework_TestCase
{
