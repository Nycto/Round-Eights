...
class classes_query_where_logic extends PHPUnit_Framework_TestCase
{
    ...
    public function testCountClauses ()
    {
        ...
        $logic->addClause( $this->getMock('r8\iface\Query\Where') );
