...
class classes_Log_Node_Hub extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Returns a test node that expects to be called with the given message
     *
     * @return \r8\iface\Log\Node
     */
    public function getTestNode ( $message )
    {
        $node = $this->getMock('\r8\iface\Log\Node');
        $node->expects( $this->once() )->method( "dispatch" )
